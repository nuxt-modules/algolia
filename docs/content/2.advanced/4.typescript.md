---
title: TypeScript
description: Add type safety to your Algolia indices and search results.
---
...
With TypeScript support, you get full autocomplete for index names and type-safe access to search results!
::
