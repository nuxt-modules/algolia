---
title: DocSearch
description: Add instant search to your documentation with Algolia DocSearch.
---
...
Websites like [nuxtjs.org](https://nuxtjs.org) and [vuejs.org](https://vuejs.org) use it to provide an instant search to users without any backend!
